...
import MessageContact from '@/components/MessengerContact';
import ContactForm from '@/components/ContactForm';
import { FiMapPin, FiMail, FiPhone, FiMessageCircle } from 'react-icons/fi';

export default function ContactPage() {
  // WhatsApp number
  const WHATSAPP_NUMBER = '8801745368299';
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a 
                        href="mailto:shihabhossain596@gmail.com" 
              ...
              <div className="space-y-6">
                ...
                {/* Direct Message Form */}
                <div className="mt-8">
                  <h3 className="text-lg font-bold mb-3">Or send me a direct message:</h3>
                  <MessageContact />
                </div>
              </div>
            </div>
